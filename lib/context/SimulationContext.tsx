...
import { SimulationState, SimulationInputs, SimulationResults, ScenarioSnapshot, DashboardModifications } from '../types';
...
export function SimulationProvider({ children }: { children: ReactNode }) {
    ...
    const updateDashboardModifications = (mods: Partial<DashboardModifications>) => {
        setState(prev => ({
            ...prev,
            dashboardModifications: {
    ...
    const reset = () => {
        setState({
            ...initialState,
            scenarios: state.scenarios, // Keep scenarios
        });
