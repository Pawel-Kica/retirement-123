                ...
                {history.map((entry, index) => {
                  return (
                    <div
                      ...
                      className="p-4 border-2 rounded-lg hover:shadow-md transition-all cursor-pointer group border-zus-grey-300 bg-white hover:border-zus-green"
                    >
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex items-center gap-2">
                          <div className="w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm bg-zus-green text-white">
                            {index + 1}
                          </div>
                          <div>
          ...
          {history.length > 0 && (
            <div className="p-4 border-t-2 border-zus-grey-300 bg-zus-grey-100">
              <button
                ...
                className="w-full py-3 px-4 bg-white border-2 border-zus-error text-zus-error rounded-lg hover:bg-zus-error hover:text-white transition-all font-semibold text-sm flex items-center justify-center gap-2"
              >
                <Trash2 className="w-4 h-4" />
